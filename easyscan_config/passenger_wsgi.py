...
SITE_PACKAGES_DIR = os.path.abspath( u'%s/../../env_ezscan/lib/python2.7/site-packages' % current_directory )
...
## load up env vars
SETTINGS_FILE = os.environ['EZSCAN__ENV_SETTINGS_PATH']  # set in activate_this.py, and activated above
import shellvars
...
# ## - env-vars loading under python3.x occurs via the `SetEnv` entry in the project's passenger.conf section
